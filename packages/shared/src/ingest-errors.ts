...
export const INGEST_ERROR_MESSAGES: Record<IngestErrorCode, string> = {
  ...
  UNSUPPORTED_REPOSITORY_PROVIDER: "Only public GitHub repositories are supported",
  REPOSITORY_NOT_FOUND: "Repository was not found or is not public",
  REPOSITORY_PRIVATE: "Private repositories are not supported",
